...
class Redis extends Connector
{
    ...
    {
        $options = [
            'host'       => Env::get('queue_redis.host', '127.0.0.1'),
            'port'       => Env::get('queue_redis.port', '6379'),
            'password'   => Env::get('queue_redis.password', ''),
            'select'     => Env::get('queue_redis.select', 1),
            'timeout'    => Env::get('queue_redis.timeout', 0),
            'expire'     => Env::get('queue_redis.expire', 60),
            'persistent' => Env::get('queue_redis.persistent', false),
            'default'    => Env::get('queue_redis.default', 'default'),
        ];
